...
def test_run_monthly_backtest():
    ...
    df_data = {
        "日期": pd.date_range("2022-12-15", "2023-01-31"),  # Include previous month
        "開盤": [30000 + i*10 for i in range(48)],
        "最高": [30200 + i*10 for i in range(48)],
        "最低": [29900 + i*10 for i in range(48)],
        "收盤": [30100 + i*10 for i in range(48)]
    }
